					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<form id="input_form" action="<?php echo base_url('inventory/add') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
								...
								<div class="form-group">
									<p class="col-md-2 col-md-offset-2">(*) Mandatory</p>
								</div>
									<div class="form-group">
										<label for="code" class="control-label col-md-2">*AD Code</label>
										<div class="col-md-2">
											<input type="text" name="code" id="code" class="form-control required" required>
										</div>
									</div>
									<div class="form-group">
										<label for="brand" class="control-label col-md-2">* Merek/Type</label>
										<div class="col-md-8">
									...
									<div class="form-group">
										<label for="height" class="control-label col-md-2">HDD / SDD</label>
										<div class="col-md-4">
											<div class="input-group">
									...
									<div class="form-group">
										<label for="length" class="control-label col-md-2">MAC Address</label>
										<div class="col-md-4">
											<input type="text" name="length" id="length" class="form-control required">
										</div>
									</div>
									<div class="form-group">
										<label for="color" class="control-label col-md-2">Operating System</label>
										<div class="col-md-4">
								...
								<fieldset>
								<div class="form-group">
									<label for="location" class="control-label col-md-2">* Departemen</label>
									<div class="col-md-4">
								...
								<div class="form-group">
									<label for="weight" class="control-label col-md-2">User</label>
									<div class="col-md-4">
